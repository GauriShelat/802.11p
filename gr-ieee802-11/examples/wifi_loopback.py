...
# Title: Wifi Loopback
# Generated: Sat Nov 24 20:10:09 2018
##################################################
...
class wifi_loopback(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_gr_complex*1, "/tmp/test1", False)
        ...
        self.connect((self.blocks_pdu_to_tagged_stream_0_0, 0), (self.blocks_file_sink_1, 0))    
