...
# Title: Wifi Tx Play
# Generated: Sun Dec  9 00:49:58 2018
##################################################
...
class wifi_tx_play(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Tx Play")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Wifi Tx Play")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "wifi_tx_play")
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.intern("Ghot buoy"), 1000)
...
def main(top_block_cls=wifi_tx_play, options=None):
