...
# Title: Wifi Rx1
# Generated: Mon Dec 10 16:41:11 2018
##################################################
...
class wifi_rx1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Wifi Rx1")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Wifi Rx1")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "wifi_rx1")
...
def main(top_block_cls=wifi_rx1, options=None):
